...
('order-001', 'ORD-2024-001', 'user-001', 1049.97, 104.99, 15.00, 1169.96, 'CONFIRMED', 'PAID', 'CREDIT_CARD', '123 Main Street', 'New York', 'NY', '10001', 'USA', '+1-555-0101', CURRENT_TIMESTAMP + INTERVAL '5 DAY', 'TRK123456789', 'Please deliver during business hours', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('order-002', 'ORD-2024-002', 'user-002', 1999.99, 199.99, 25.00, 2224.98, 'SHIPPED', 'PAID', 'CREDIT_CARD', '456 Oak Avenue', 'Los Angeles', 'CA', '90210', 'USA', '+1-555-0102', CURRENT_TIMESTAMP + INTERVAL '3 DAY', 'TRK987654321', 'Signature required', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('order-003', 'ORD-2024-003', 'user-003', 59.99, 6.00, 10.00, 75.99, 'DELIVERED', 'PAID', 'DEBIT_CARD', '789 Pine Street', 'Chicago', 'IL', '60601', 'USA', '+1-555-0103', CURRENT_TIMESTAMP - INTERVAL '2 DAY', 'TRK456789123', 'Left with neighbor', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO orders (id, order_number, user_id, subtotal, tax_amount, shipping_amount, total_amount, status, payment_status, payment_method, delivery_address, delivery_city, delivery_state, delivery_zip_code, delivery_country, delivery_phone, estimated_delivery_date, tracking_number, notes, created_at, updated_at) VALUES
('order-004', 'ORD-2024-004', 'user-004', 89.99, 9.00, 10.00, 108.99, 'PROCESSING', 'AUTHORIZED', 'CREDIT_CARD', '321 Elm Street', 'Boston', 'MA', '02101', 'USA', '+1-555-0104', CURRENT_TIMESTAMP + INTERVAL '7 DAY', 'TRK789123456', 'Apartment building - call upon arrival', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('order-005', 'ORD-2024-005', 'user-001', 149.99, 15.00, 15.00, 179.99, 'PENDING', 'PENDING', 'DIGITAL_WALLET', '123 Main Street', 'New York', 'NY', '10001', 'USA', '+1-555-0101', CURRENT_TIMESTAMP + INTERVAL '10 DAY', NULL, 'Second order from this customer', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
